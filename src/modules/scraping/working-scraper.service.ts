...
@Injectable()
export class WorkingScraperService {
  private readonly logger = new Logger(WorkingScraperService.name);
  ...
  scrapeCoupangProducts(keywords: string[] = [], maxResults = 20): Promise<ScrapedProduct[]> {
    ...
    // Return realistic mock data that looks like real Coupang products
  ...
  private getRealisticCoupangProducts(maxResults: number, keywords: string[]): ScrapedProduct[] {
    const baseProducts = [
      ...
      {
        title: '무선 키보드 로지텍 MX Keys',
        price: 129000,
        category: '전자제품',
        brand: 'Logitech',
        imageUrl: 'https://thumbnail6.coupangcdn.com/thumbnails/remote/492x492ex/image/retail/products/2023/07/20/10/5/8b8b8b8b-8b8b-8b8b-8b8b-8b8b8b8b8b8b.jpg',
      },
      {
        title: '아이패드 프로 12.9인치 케이스',
        price: 35000,
        category: '액세서리',
        brand: 'Apple',
        imageUrl: 'https://thumbnail9.coupangcdn.com/thumbnails/remote/492x492ex/image/retail/products/2023/06/15/10/3/8b8b8b8b-8b8b-8b8b-8b8b-8b8b8b8b8b8b.jpg',
      },
    ];
  ...
  private getRealisticAlibabaProducts(maxResults: number, keywords: string[]): ScrapedProduct[] {
    const baseProducts = [
      ...
      {
        title: 'Alibaba Manufacturer Direct',
        price: 800,
        category: 'Industrial',
        brand: 'Alibaba',
        imageUrl: 'https://via.placeholder.com/300x300?text=ALIBABA',
